...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    region: "East Khasi Hills",
    tagline: "Cliffs, falls, and the classic Meghalaya rain country.",
    overview:
      "Sohra (Cherrapunji) is Meghalaya’s storied rain plateau — waterfalls plunging off limestone cliffs, caves, and viewpoints that defined Northeast tourism for decades. TRIS journeys treat it as more than a checklist: time for mist, local food, and connecting onward to quieter villages rather than racing every lookout.",
    highlights: [
      "Iconic waterfall viewpoints",
      "Limestone caves and plateaus",
      "Gateway toward root-bridge country",
      "Strong monsoon character year-round",
    ],
    distances: {
      shillong: "~55 km",
      guwahatiAirport: "~175 km",
      umroiAirport: "~80 km",
    },
