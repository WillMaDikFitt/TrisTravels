...
const toc = [
  { id: "booking", label: "1. Booking Confirmation & Payment" },
  { id: "transportation", label: "2. Transportation" },
  { id: "accommodation", label: "3. Accommodation" },
  { id: "cancellation", label: "4. Cancellation & Refund Policy" },
  { id: "duration", label: "5. Duration & Daily Operating Hours" },
  { id: "itinerary", label: "6. Changes to the Itinerary" },
  { id: "conduct", label: "7. Driver Conduct & Passenger Behaviour" },
  { id: "belongings", label: "8. Passenger Responsibility & Personal Belongings" },
  { id: "fees", label: "9. Driver Fees, Fuel & Tolls" },
  { id: "safety", label: "10. Safety" },
  { id: "suppliers", label: "11. Third-Party Suppliers & Service Arrangements" },
  { id: "force-majeure", label: "12. Natural Calamities, Force Majeure & Unforeseen Circumstances" },
  { id: "insurance", label: "13. Insurance" },
  { id: "media", label: "14. Photography & Media" },
  { id: "amendments", label: "15. Special Requests & Booking Amendments" },
  { id: "health", label: "16. Traveller Health, Fitness & Suitability" },
  { id: "disputes", label: "17. Dispute Resolution" },
  { id: "acceptance", label: "18. Acceptance of Terms" },
...
export default function PackageTermsPage() {
  return (
    <LegalShell
      title="Terms & Conditions — Package Tours"
      subtitle="TRIS Travels – Package Booking Terms & Conditions"
      effective="Effective from August 2026 onwards"
      intro={
        <p>
      ...
      notice={
        <p>
          ...
          . For a summary of refunds, see our{" "}
      ...
      toc={toc}
      relatedExcludeHref="/terms"
      footerNote="Effective from August 2026 until further notice."
    >
      <LegalSection id="booking" number="01" title="Booking Confirmation & Payment">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="transportation" number="02" title="Transportation">
      ...
      <LegalSection id="accommodation" number="03" title="Accommodation">
        ...
        <LegalSubheading>3.1 Accommodation Categories</LegalSubheading>
        ...
        <LegalSubheading>3.2 Accommodation Conditions</LegalSubheading>
        <LegalBulletList
          items={[
      ...
      <LegalSection id="cancellation" number="04" title="Cancellation & Refund Policy">
        <p className="text-sm leading-relaxed text-on-surface-variant md:text-[0.95rem]">
          ...
          . A dedicated summary is also available on our{" "}
      ...
      <LegalSection id="duration" number="05" title="Duration & Daily Operating Hours">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="itinerary" number="06" title="Changes to the Itinerary">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="conduct" number="07" title="Driver Conduct & Passenger Behaviour">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="belongings" number="08" title="Passenger Responsibility & Personal Belongings">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="fees" number="09" title="Driver Fees, Fuel & Tolls">
        <p className="text-sm text-on-surface-variant md:text-[0.95rem]">
      ...
      <LegalSection id="safety" number="10" title="Safety">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="suppliers" number="11" title="Third-Party Suppliers & Service Arrangements">
        <LegalBulletList
          items={[
      ...
      >
        <p className="text-sm leading-relaxed text-on-surface-variant md:text-[0.95rem]">
          TRIS Travels will not be responsible for delays, changes, interruptions or cancellations
          resulting from circumstances that are beyond its reasonable control.
        </p>
      ...
      <LegalSection id="media" number="14" title="Photography & Media">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="amendments" number="15" title="Special Requests & Booking Amendments">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="health" number="16" title="Traveller Health, Fitness & Suitability">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="disputes" number="17" title="Dispute Resolution">
        <LegalBulletList
          items={[
      ...
      <LegalSection id="acceptance" number="18" title="Acceptance of Terms">
        <p className="text-sm leading-relaxed text-on-surface-variant md:text-[0.95rem]">
          By making a payment towards a TRIS Travels package booking, the traveller confirms that:
        </p>
        <LegalBulletList
          items={[
