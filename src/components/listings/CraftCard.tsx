  ...
  return (
    ...
    >
      <div className="relative bg-surface-container p-3 pb-0">
        ...
        {product.bestSeller && (
          <span className="absolute top-5 left-5 w-fit rounded-full bg-secondary px-2.5 py-1 text-[9px] font-bold tracking-[0.12em] text-on-secondary uppercase">
            Featured
          </span>
        )}
      </div>
      ...
      <div className="flex flex-1 flex-col px-4 pt-4 pb-4">
        ...
        <div className="mt-4 border-t border-outline-variant/25 pt-3">
          <Link
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-outline-variant/40 px-4 py-2.5 text-[11px] font-bold tracking-[0.12em] text-secondary uppercase transition group-hover:border-primary group-hover:bg-primary group-hover:text-on-primary"
          >
